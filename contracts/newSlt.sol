...
contract SltGame is Initializable,OwnableUpgradeable {
   ...
   // 设置方法
    function initialize() initializer public {
        ...
        precision  = 1e18;
        topAddress = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266; // 设置初始主地址，记得要把主地址的level调高
        levelFee = [100, 120, 140, 160, 180, 200, 220, 240, 260, 280];
        sltReward = [200, 240, 280, 320, 1360, 400, 440, 480, 520, 560]; 
    }
